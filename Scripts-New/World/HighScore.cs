...
public class HighScore : MonoBehaviour {
	...
	Dictionary<string, int> _unlock_simple;
	/*
		al gemaakte functie om values in functie te zetten;
		SetUnlockValues("Unlock", 1);
	*/
	Dictionary<string, Dictionary<string, int>> _unlock_beter;
	/*
		al gemaakte functie om values in functie te zetten;
		SetUnlockValues("Unlock", "Unlock_skin", 1);
	*/
	Dictionary<string, Dictionary<string, Dictionary<string,int>>> _unlock_good;
	/*
		al gemaakte functie om values in functie te zetten;
		SetUnlockValues("Unlock", "Unlock_skin", "Player1",1);
	*/
